...
app.post('/sign',(req,res) => {
    let data = {username:req.body.username,email:req.body.email,phone:req.body.phone,subscription:req.body.subscription, password: req.body.password,pdate:req.body.pdate,edate:req.body.edate};
    console.log(data);
...
app.get('/okla/:email',function(req,res){
    ...
    res.write('<a href=http://localhost:3000/25661ffxix${email}" \n');
...
// -----------------emergency email send-------email send-------------------- 

app.get("/emgmail/:email",(req, res) => {
    try {
      const email = req.params.email;
...
app.listen(3304,()=>{
    console.log(`express server running on 3304`);
});
