...
//function PassChange(){
  //var data ={"password":password,"password1":password1};
  //console.log(data);
    // axios.post("http://localhost:3306/nowpass",data).then(
      //   res=> setResult(res))
  //console.log(result)
...
const response = await fetch ('http://localhost:3306/nowpass',config)
...
<div >
				...
				<div class="form-groups">
					...
					<input type="password" class="form-control form-control-sm" style={{width:500}} placeholder="old password" onChange={handelDemo1}/>
				</div>
				<div class="form-group">
					<label for="exampleInputEmail1">New password</label>
					<input type="password" class="form-control form-control-sm" style={{width:500}} placeholder="new password" onChange={handelDemo2}/>
				</div>
				<button type="submit" class="btn btn-primary" onClick={PassChange}>Confirm</button>
	</div>
