...
function Rejected()
{
  ...
  useEffect(()=>{
     axios.get("http://54.150.175.15:3306/reje").then(res=>setProducts(res.data));
 },[]);
...
{/* 
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Rejected Hotspots</h1>
            
          </div>
<table id="example" class="table table-striped table-bordered" >
        <thead>
         
            <th class="bl5">Id</th> <th class="bl5">User Email</th> <th class="bl5">Title</th><th class="bl5">Description</th><th class="bl5">Published By</th><th class="bl5">Lat:,Long</th>
            <th class="bl5">Reason</th>
        </thead>
        <tbody>
...
<a class="scroll-to-top rounded" href="Rejected">
