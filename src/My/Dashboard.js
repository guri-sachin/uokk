...
function Dashboard()
{
  ...
  const navigate = useNavigate();
   useEffect(()=>{
      axios.get("http://54.150.175.15:3306/sums").then(res=>setProducts(res.data));
  },[]);

  useEffect(()=>{
    axios.get("http://54.150.175.15:3306/spots").then(res=>setProducts1(res.data));
},[]);

useEffect(()=>{
  axios.get("http://54.150.175.15:3306/newreq").then(res=>setProducts2(res.data));
},[]);

useEffect(()=>{
  axios.get("http://54.150.175.15:3306/current").then(res=>setProducts3(res.data));
},[]);
return(
...
<!-- Content Wrapper --> */}
    ...
    <div class="row">
          ...
          <div class="col-md-6">
          <div class="da">
          <div class="da1">Total Number of Requests</div>
...
<hr></hr>
          <div class="col-md-6">
          <div class="da">
          <div class="da1">today new registered</div>
