...
function Allhotspots()
{
  ...
  useEffect(()=>{
     axios.get("http://3.101.23.81:3306/lusers").then(res=>setProducts(res.data));
 },[]);
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">Users location</h1>
...
<thead>
  ...
  <tr>
  <th class="bl5">User Name</th>  <th class="bl5">Email</th><th class="bl5">Lat, Long</th> 
  </tr>
</thead>
<tbody>
