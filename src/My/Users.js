...
function Users(){
   ...
   const navigate = useNavigate();
    useEffect(()=>{
       axios.get("http://3.101.23.81:3306/Users").then(res=>setProducts(res.data));
   },[]);
 ...
 function Shows(e){
    ...
    axios.get(`http://3.101.23.81:3306/pinoa/${id}`).then(
      res => setProducts(res.data));
    
    axios.get(`http://3.101.23.81:3306/noia/${id}`).then(
        res => setProducts(res.data));
        navigate("/Blocked");
...
{/* 
  ...
  <li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href={"Users"}>Registered Users</a>
  ...
  <li class="nav-item">
    ...
    <div id="collapseFour" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href={"Allhotspots"}> Hotspots</a>
  ...
  <li class="nav-item" >
    <a class="nav-link" href={"Subscribed"}>
     <i class="fas fa-fw fa-cog"></i>
...
<h1 class="h3 mb-0 text-gray-800">User List</h1>  
      ...
      <thead>
              <th>Id</th><th>Name</th><th>email-adderss</th><th>phone</th><th>sub</th><th>Restrict User</th>
      </thead>
         <tbody>
             {product.map((item,index)=>{
                 return(
                     <tr key={index}>
                         ...
                         <td>
                          <Button type="button"class="btn btn-success av"  id={item.id}  onClick ={Shows}>DELETE</Button>
                         </td>
