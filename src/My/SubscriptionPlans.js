...
function Plans()
{
  ...
  const navigate = useNavigate();
   useEffect(()=>{
      axios.get("http://54.150.175.15:3306/plan").then(res=>setProducts(res.data));
  },[]);
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">Sub plans</h1>
...
<thead>
  ...
  <tr>
      ...
      <th class="bl5">Duration</th>
      <th class="bl5">Amount</th>
             ...
             {product.map((item,index)=>{
                 return(
                     <tr key={index}>
                         ...
                         <td>
                          <Button type="button"class="btn btn-success av"  id={item.id}  onClick={show} >Edit</Button>
                         </td>
