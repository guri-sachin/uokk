...
import './App.css';
import {Form,Button,Navbar,Nav,Container,Carousel,Table, ModalTitle} from 'react-bootstrap';
...
function Allhotspots()
{
  ...
  useEffect(()=>{
     axios.get("http://54.150.175.15:3306/allm").then(res=>setProducts(res.data));
 },[]);
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">All Hotspot</h1>
...
<thead>
  ...
  <tr>
  <th class="bl5">Lat,Long</th>  <th class="bl5">Description</th><th class="bl5">Published By</th> <th class="bl5">Title</th>
  </tr>
</thead>
<tbody>
...
<a class="scroll-to-top rounded" href="Allhotspots">
